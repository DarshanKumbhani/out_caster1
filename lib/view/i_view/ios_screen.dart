...
import '../../provider/outcaster_provider.dart';
...
class _iOS_Setting_UIState extends State<iOS_Setting_UI> {
    ...
    return CupertinoPageScaffold(
        ...
        child: Column(
          ...
          children: [
            ...
            Liner(),
            SecurityTile(title:"Change Password",icon: CupertinoIcons.lock_circle_fill,swit: spT!.changepassword,onchangemethod: spF!.changepasswordfun),
  ...
  Widget CommonTile({String? title, IconData? icon, String? additional})
  {
    return CupertinoListTile(
      ...
      leading: Icon(icon, size: 25, color: CupertinoColors.systemGrey,),
      title: Text("$title"),
